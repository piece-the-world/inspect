...
extends View {
    ...
    public void a() {
        ...
        this.k = com.growingio.android.sdk.utils.j.a(this.getContext(), 80.0f);
        this.e = com.growingio.android.sdk.utils.j.a(this.getContext(), 120.0f);
        this.f = com.growingio.android.sdk.utils.j.a(this.getContext(), 80.0f);
        this.h = com.growingio.android.sdk.utils.j.a(this.getContext(), 16.0f);
        this.g = com.growingio.android.sdk.utils.j.a(this.getContext(), 18.0f);
    }
    ...
    public void a(Rect rect, int n2, int n3) {
        ...
        float f2 = (float)(this.e / 2 - com.growingio.android.sdk.utils.j.a(this.getContext(), 2.0f)) / 1.17f;
        ...
        int n5 = com.growingio.android.sdk.utils.j.a(this.getContext(), 1.0f);
    ...
    private void a(View[] paint, float f2) {
        ...
        Paint paint2 = new Paint();
        paint2.setAntiAlias(true);
        paint2.setStrokeWidth((float)com.growingio.android.sdk.utils.j.a(this.getContext(), 1.0f));
        paint2.setStyle(Paint.Style.STROKE);
        paint2.setColor(-436254684);
        canvas.drawRoundRect(new RectF(this.c), f2, f2, paint2);
        paint2.setStyle(Paint.Style.FILL);
        paint2.setColor(1291798564);
        canvas.drawRoundRect(new RectF(this.c), f2, f2, paint2);
    }
