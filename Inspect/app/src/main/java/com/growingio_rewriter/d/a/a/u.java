...
extends n {
    ...
    public u(int n2, String string, r r2, q q2) {
        this(327680, n2, string, r2, q2);
    }

    protected u(int n2, int n3, String string, r r2, q q2) {
    ...
    public a c() {
        a a2 = super.c();
        return a2 == null ? a2 : new com.growingio.d.a.a.r(a2, this.a);
    }
