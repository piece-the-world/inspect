...
RandomAccess {
    ...
    public Byte a(int n2) {
        aU.a(n2, this.size());
        return Byte.valueOf(this.a[this.b + n2]);
    }

    @Override
    public boolean contains(Object object) {
        return object instanceof Byte && d.a(this.a, ((Byte)object).byteValue(), this.b, this.c) != -1;
    }

    @Override
    public int indexOf(Object object) {
        int n2;
        if (object instanceof Byte && (n2 = d.a(this.a, ((Byte)object).byteValue(), this.b, this.c)) >= 0) {
            return n2 - this.b;
        }
        return -1;
    }
    ...
    public int lastIndexOf(Object object) {
        int n2;
        if (object instanceof Byte && (n2 = d.b(this.a, ((Byte)object).byteValue(), this.b, this.c)) >= 0) {
            return n2 - this.b;
        }
        return -1;
    }
    ...
    public Byte a(int n2, Byte by2) {
        ...
        this.a[this.b + n2] = aU.a(by2).byteValue();
