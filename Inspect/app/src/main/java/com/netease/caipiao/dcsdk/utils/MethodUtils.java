        ...
        if (cachedMethod == null) {
            try {
                ...
                for (Method method2 : cls.getMethods()) {
                    if (method2.getName().equals(methodName) && MemberUtils.isAssignable((Class[]) parameterTypes, method2.getParameterTypes(), true)) {
    ...
    public static <T> Constructor<T> getMatchingAccessibleConstructor(Class<T> cls, Class<?>... parameterTypes) {
        ...
        try {
            ...
            while (i < length) {
                ...
                if (MemberUtils.isAssignable((Class[]) parameterTypes, ctor2.getParameterTypes(), true)) {
